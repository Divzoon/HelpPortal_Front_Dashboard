...
const TaskHeader = () => {
  ...
  return (
    <div className="flex flex-col gap-y-4 rounded-2xl border border-stroke bg-white p-3 shadow-default dark:border-strokedark dark:bg-boxdark sm:flex-row sm:items-center sm:justify-between">
      <div>
